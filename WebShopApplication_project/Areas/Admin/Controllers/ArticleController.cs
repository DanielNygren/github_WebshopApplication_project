...
namespace WebShopApplication_project.Areas.Admin.Controllers
{
    ...
    public class ArticleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,ArticleNumber,Name,Price,Description,Hight,Whith,Depth,NetWweight,GrossWeight,DateTimeItemCreated,DateTimeItemUpdated,CategoryId")] Article article)
        {
